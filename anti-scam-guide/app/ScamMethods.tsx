...
const RAW_QUIZ_POOL: {
  ...
  },
  {
    ...
    hint: "臉書看到免費領取白沙屯媽祖手鍊廣告，私訊後收到假交易平台連結，對方以『實名制認證失敗、帳戶遭鎖定』為由，恐嚇被害人將實體金融卡寄出並提供密碼。",
    isTrue: true,
    details: "沒錯，這確實 es【假宮廟名義/騙取人頭帳戶詐騙】。不法分子利用信徒對神明的虔誠心理以結緣品為幌子，再透過假話術恐嚇騙取實體卡作洗錢帳戶。",
    link: "https://www.mirrormedia.mg/story/20260503soc001"
  },
  // === 新聞素材 7 ===
  {
  ...
  },
  {
    ...
    hint: "網購蒜頭雞蛋時，假客服誆稱須完成實名制才能交易，誘導民眾加入 LINE 官方帳號並開啟『派對模式（分享螢幕）』，藉機側錄民眾的手機轉帳與付款 QR Code。",
    isTrue: false,
    details: "這其實是【LINE 派對模式側錄詐騙】！歹徒核心手法是利用通訊軟體的內建螢幕分享功能，即時側錄被害人操作手機畫面進而盜取金融資料。",
    link: "https://www.mirrormedia.mg/story/20260430edi034"
  },
  // === 新聞素材 8 ===
  {
  ...
  },
  {
    ...
    hint: "社群宣稱『免費贈送 iPhone 手機』，加 LINE 後假客服以實名認證失敗為由，引導民眾到 ATM 操作『無卡提款』功能以提供『財力證明』，進而騙走無卡提款序號。",
    isTrue: true,
    details: "沒錯，這確實 es【假贈獎/騙取無卡提款序號】的手法。在社群利用高價產品吸引好康群眾，並將 ATM「無卡提款」包裝成驗證流程藉此隔空取款。",
    link: "https://www.mirrormedia.mg/story/20260503soc004"
  },
  // === 新聞素材 9 ===
  {
  ...
  },
  {
    ...
    hint: "Threads 上出現大量自稱 7-11 店員的新帳號，稱為了完成經理交付的『漲粉絲』任務，只要網友按下追蹤並私訊，就能免費領取布丁、泡麵與不鏽鋼杯等福利。",
    isTrue: true,
    details: "沒錯，這確實 es【社群假帳號增粉/個資詐騙】。不法分子集體註冊山寨知名企業員工帳號，利用免費贈送物資噱頭快速獲取追蹤，實則長線收集個資。",
    link: "https://www.mirrormedia.mg/story/20260404edi008"
  },
  // === 新聞素材 11 ===
  {
    ...
    isTrue: true,
    details: "沒錯，這確實 es【假冒公務機關或檢警詐騙】的經典手法。不法分子利用民眾對司法的畏懼，以監管帳戶為由施壓。警檢絕不會在電話中辦案或監管財產。",
  ...
  // === 新聞素材 12 ===
  {
    ...
    hint: "民眾收到一封自稱是 Facebook 官方的電子郵件，警告帳號出現異常登入，並附帶一個『這不是我本人』的按鈕。當事人因慌張按下按鈕後，被引導至一個要求輸入臉書帳號與網銀密碼的網頁，完成後導致個人社群帳號當場被盜走。",
    isTrue: false,
    details: "這其實是【惡意釣魚連結詐騙】的手法！本案為利用假社群官方信件進行釣魚盜帳號，並非在報稅季假冒稅務機關公務員要求補繳稅款。",
    link: "https://www.mirrormedia.mg/story/20260515edi021"
  },
  {
    category: "網路社會與通訊軟體",
    ...
    hint: "民眾收到一封自稱是 Facebook 官方的電子郵件，警告帳號出現異常登入，並附帶一個『這不是我本人』的按鈕。當事人因慌張按下按鈕後，被引導至一個要求輸入臉書帳號與網銀密碼的網頁，完成後導致個人社群帳號當場被盜走。",
    isTrue: true,
    details: "沒錯，這確實 es【惡意釣魚連結詐騙】。不法分子利用假系統警告製造恐慌，引導至假網頁輸入帳密與登入憑證來竊取個人社群帳號控制權。",
    link: "https://www.mirrormedia.mg/story/20260515edi021"
  },
  // === 新聞素材 13 ===
  {
    ...
    isTrue: false,
    details: "這其實是【利用職務偽造保單非法吸金】的手法！嫌犯並非透過網路、簡訊引導加入飆股群組，而是身為保險公司高階主管，直接利用實體熟人關係與偽造公司商標文書來誘騙親友。",
  ...
  },
  {
    ...
    hint: "保險公司通訊處前經理利用保戶與親友的信任，長達 20 年自行印製假契約，推銷宣稱年報酬率 5% 至 14% 的假保險與信託憑證商品，將吸金近五千萬元挪作個人周轉，最後因周轉失靈被檢方起訴並建請從重量刑。",
    isTrue: true,
    details: "沒錯，這確實 es【利用職務偽造保單非法吸金】的手法。高階主管自製假契約與高回報率商品，直接進行長達20年的龐氏吸金騙局。",
    link: "https://www.mirrormedia.mg/story/20260630edi045"
  },
  // === 新聞素材 14 ===
  {
  ...
  },
  {
    ...
    hint: "地方教會牧師利用宗教信仰對信眾進行心靈控制，貶低被害人父母並宣稱財產應留給教會，甚至鼓勵信徒將保險受益人及財產規劃與教會連結、大力募款，涉嫌財產詐騙金額超過千萬元，遭台中地檢署分案偵辦。",
    isTrue: true,
    details: "沒錯，這確實 es【利用宗教信仰心靈控制與斂財】。不法分子假借神職人員威權孤立個體，進而使其在特定精神控制與壓力下主動奉獻大筆財產。",
    link: "https://www.mirrormedia.mg/story/20260630-167inv-123147"
  },
  // === 新聞素材 15 ===
  {
    ...
    isTrue: true,
    details: "沒錯，這確實 es【假贈獎騙取無卡提款序號】的手法。歹徒同時扮演假賣家與假客服，配合假家暴影片施加心理壓力，隔空騙取無卡提款 QR Code 序號。",
  ...
  },
  {
    ...
    hint: "郭姓主嫌為首的洗錢集團，利用『Fppay』、『鑫豪支付』等新興支付平台，結合多間人頭公司的金融帳戶進行虛假交易，幫博弈與詐騙集團進行代收代付，在短期內暗中洗錢高達 4 億 4,761 萬多元，遭檢警大規模搜索並聲押禁見獲准。",
    isTrue: true,
    details: "沒錯，這確實 es【人頭公司與支付平台跨境洗錢水房】。利用合法的第三方支付系統或新興支付平台，透過大量人頭公司帳戶做假交易將不法髒錢代收洗白。",
    link: "https://www.mirrormedia.mg/story/20260629-169soc-160655"
  },
  // === 新聞素材 17 ===
  {
    ...
    isTrue: true,
    details: "沒錯，這確實 es【假交友戀愛詐騙】的手法！利用情感與信任編造網戀懷孕等藉口索取財物，並透過網路下載圖片與偽造公文書來使騙局逼真。",
  ...
  // === 新聞素材 18 ===
  {
    ...
    isTrue: true,
    details: "沒錯，這確實 es【假冒國稅局補繳稅款詐騙】的手法。不法分子假冒稅務公務員電話催繳施壓，記住政府機關絕對不會電話指示操作實體 ATM 或網銀功能。",
  ...
  },
  {
    ...
    isTrue: false,
    details: "這其實是【假冒國稅局補繳稅款詐騙】的手法！此手法是假冒公權力機關進行強制性催繳恐嚇，與引誘民眾加入 LINE 投資群組的假飆股完全不同。",
    link: "https://www.mirrormedia.mg/story/20260508edi041"
  },
  // === 新聞素材 19 ===
  {
  ...
  },
  {
    ...
    hint: "北市婦人誤信認識一年的朋友介紹，稱只要投入 500 萬元本金投資某金融科技公司，就能『月領 15 萬』收益，保證年投報率高達 36%。婦人因此賣掉長期持有的 0050 ETF 欲臨櫃匯款，所幸被派出所所長與行員及時攔阻，成功保住 500 萬積蓄。",
    isTrue: true,
    details: "沒錯，這確實 es【實體熟人/假金融科技公司保證獲利投資詐騙】。利用定期超常高配息話術引導解約穩健的 0050 進行匯款，面對暴利應保持高度警覺。",
    link: "https://www.mirrormedia.mg/story/20260410edi013"
  },
  // === 新聞素材 20 ===
  {
    ...
    isTrue: true,
    details: "沒錯，這確實 es【假冒官方中獎通知釣魚詐騙】的手法。利用高仿山寨中獎網頁竊取信用卡個資與 OTP 刷卡驗證簡訊以完成線上大量盜刷。",
  ...
  },
  {
    ...
    hint: "民眾收到偽裝成『悠遊卡官方會員中心』的電子郵件通知發票中獎，點擊信中連結進入與官網一模一樣的假網頁，並依指示輸入信用卡號、有效期限與背面驗證碼。隨後手機收到簡訊，民眾未注意是『刷卡驗證通知』便將驗證碼填入，導致信用卡當場遭盜刷 7 萬 7,270 元。",
    isTrue: false,
    details: "這其實是【假冒官方中獎通知釣魚詐騙】的手法！嫌犯是利用假網頁騙取信用卡號與轉帳 OTP 碼，並非發送簡訊大肆發送惡意下載 APP 的連結。",
    link: "https://www.mirrormedia.mg/story/20260305edi033"
  }
];
