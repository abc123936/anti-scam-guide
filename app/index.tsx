  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.topSection}>
        ...
        >
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={styles.description}>點擊進入最新偽新聞篩選與分析專區</Text>
          </View>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.bottomSection}>
        ...
        {/* 3. 待定 (佔右下 1/2) */}
        <TouchableOpacity style={[styles.box, styles.bottomBox, styles.box3]}>
          <Text style={styles.boxNumberSmall}>3</Text>
          <Text style={styles.boxTitleSmall}>3. 待定</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
